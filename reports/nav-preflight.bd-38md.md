...
Generated: 2026-02-16T01:52:40.067Z
Scene manifest: `assets/scenes/cozy_office_v0.scene.json`
Report path: `reports/nav-preflight.bd-38md.md`
...
- Re-run command:
  - `node tools/nav-preflight.mjs --scene assets/scenes/cozy_office_v0.scene.json --out reports/nav-preflight.bd-38md.md`
